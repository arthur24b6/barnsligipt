 ...
 *   jQuery object to append the thumbnail to.
 * @param string src
 *   URL of the image to create a thumbnail from.
 */
function generateThumb(element, src) {
	return function(ex) {
    ...
    var thumb = document.createElement("img");
      ...
      console.log('No preview thumb: ' + src);
			thumb.src = _exifImgs.nothumb;
		}

    $(thumb).prependTo(element);
	}
}
